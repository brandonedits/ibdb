    ...
    <form action="<?php echo URLROOT; ?>/books/addBook" method="post">
      ...
      <?php else: ?>
        ...
        <div class="input-group control-group">
          <div class="col-sm-6 input-group">
                <input type="text" name="author_fName[]" class="form-control form-control-lg <?php echo (!empty($data['author_fName_err'])) ? 'is-invalid' : ''; ?>" value="" placeholder="first">
          </div>
        
          <div class="col-sm-6 input-group">
              <input type="text" name="author_lName[]" class="form-control form-control-lg <?php echo (!empty($data['author_lName_err'])) ? 'is-invalid' : ''; ?>" value="" placeholder="last">

              <div class="input-group-btn">
                <button class="btn btn-lg btn-success add-more" type="button"><i class="fas fa-plus "></i></button>
              </div>          
          </div>
